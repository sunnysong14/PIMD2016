...
% 
function [Out1, Out2, Out3] = fastica_LY(mixedsig, varargin)
...
stabilization     = 'off';
epsilon           = 0.0001;
maxNumIterations  = 50000;  %<-- Original set is 1000, but some ICs do not converge.
maxFinetune       = 5;
...
elseif only == 2    % only PCA & whitening
  ...
  if nargout == 2
    Out1 = A;
    Out2 = W;
  else              % <-- output arguments:  estimate of the mixing matrix A and its inverse W.
    Out1 = icasig;
    Out2 = A;
    Out3 = W;
  end
