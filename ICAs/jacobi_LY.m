% JACOBI_DIAGCUMMT          Jacobi diagonalizing cumulant matrix
%
% INPUT ARGUMENTS
...
% Wrapped from the orginal JADE codes.
%   last updated: 04-15-2016 for NIPS16, to include ecoICA.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function Demix_mat = jacobi_LY(CM, Whiten_mat, nSource, nSensor, nSample, nCumMat, verbose)
