...
% LY: w: demixing matrix W, i.e. inverve of mixing matrix A
%     wz: whitening matrix.

% calculates wz, w and uu. The matrix x gets overwritten by a sphered version of x. 
%%%%%%%%%%%%%%%Start RunICA
...
wz=2*inv(sqrtm(c));  % LY: whitening matrix
x=wz*x;%whitening\n');
%%%%%End spherex
